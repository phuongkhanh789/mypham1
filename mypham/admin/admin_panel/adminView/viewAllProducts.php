...
<div >
  ...
  <table class="table ">
    ...
    <tr>
      ...
      <td><?=$row["price"]?></td>     
      <td><button class="btn btn-primary" style="height:40px" onclick="itemEditForm('<?=$row['product_id']?>')">Sửa</button></td>
      <td><button class="btn btn-danger" style="height:40px" onclick="itemDelete('<?=$row['product_id']?>')">Xoá</button></td>
      </tr>
      <?php
            $count=$count+1;
          }
